...
@ContextConfiguration(locations = { "classpath:orm/applicationContext-hbt-anno.xml" })
@Transactional
public class TestAnnoHibernateDao extends AbstractTransactionalJUnit4SpringContextTests {
