...
@ContextConfiguration(locations = {"classpath:orm/applicationContext-mybatis.xml"})
@Rollback
@Transactional
public class TestMybatisBbtForum extends AbstractTransactionalJUnit4SpringContextTests {
